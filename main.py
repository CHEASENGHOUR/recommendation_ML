...
main.py
-------
Entry point — delegates to the training pipeline.

Fixes vs original
-----------------
* `from datetime import datetime` moved to top-level (was inside __main__)
* `engine.save()` now called BEFORE `os.path.getsize()` (order was reversed)
* Cleaner structure — training logic lives in pipelines/training_pipeline.py
"""
